...
Title: Video Classification Testing
)
"""
...
"""   uncomment to train the train and test folder
test_data, test_labels = prepare_all_videos(test_df, "test")
np.save("test_data2.npy", test_data)
np.save("test_labels2.npy", test_labels)
...
#lets try load files
train_data, train_labels = np.load("train_data2.npy"), np.load("train_labels2.npy")
test_data, test_labels = np.load("test_data2.npy"), np.load("test_labels2.npy")
...
def run_experiment():
    ...
    filepath = "\\keras\\ucf101top5\\tmp\\videoclassifier2"
    #filepath = ("videoclassifier")
...
#test prediction on one file
test_video = "C:\\keras\\ucf101top5\\test\\v_WZ_g02_C03.mp4"
